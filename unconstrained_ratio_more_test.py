...
OUTPUT_DIR = f'results/data/unconstrained_ratio_more_test/{METHOD}_{DIVISOR}/{EXPERIMENT}/'
OUTPUT_DIR_MODEL = f'results/model/unconstrained_ratio_more_test/{METHOD}_{DIVISOR}/{EXPERIMENT}/'
...
test_ratios = [i for i in all_ratios if i not in train_ratios and i not in val_ratios]
