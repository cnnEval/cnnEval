...
OUTPUT_DIR = f'results/data/unconstrained_height_more_test/{METHOD}_{DIVISOR}/{EXPERIMENT}/'
OUTPUT_DIR_MODEL = f'results/model/unconstrained_height_more_test/{METHOD}_{DIVISOR}/{EXPERIMENT}/'
...
test_heights = [i for i in all_heights if i not in train_heights and i not in val_heights]
