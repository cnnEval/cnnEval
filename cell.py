...
OUTPUT_DIR = f'results/data/cell/{METHOD}_{DIVISOR}/'
OUTPUT_DIR_MODEL = f'results/model/cell/{METHOD}_{DIVISOR}/'
...
val_num = int(cell_num * 0.2)
test_num = int(cell_num * 0.2)
train_num = int(round((cell_num - val_num - test_num)/DIVISOR))

all_set = list(range(min_cell, max_cell + 1))
